...
import { Loader, PenLine, User } from 'lucide-react';
import { Avatar, AvatarFallback, AvatarImage } from '@/components/ui/avatar';
import { IClient } from '@/interfaces';
import { isUpdatingDocumentClient } from '@/atoms/documents.atom';
import { useAtom } from 'jotai';

const DocumentClientInfosBox = ({ client }: { client: IClient }) => {
          ...
          <div>
            ...
            {client && (
              <div className='flex items-center gap-3'>
                <div className='border bg-white dark:bg-secondary p-2 w-full flex items-center gap-3'>
                  <Avatar>
